...
<body>
  ...
  <div class="container">
        ...
        <div class="col-md-10">
            <div class="well well-md"><center>Logged in as Accountant</center></div>
        </div>
    ...
    <div class="container">
      <?php
            if( isset($_SESSION['amessage'])): ?>
                ...
                <div class="alert alert-<?=$_SESSION['amsg_type']?> alert-dismissable fade in">
          ...
          <div class="panel-body">
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
              <thread>
                ...
                WHERE ToLab = 'No'
                AND ToAccounts = 1") or die($mysqli->error());
                ...
                <tr>
                   ...
                   <td><?php echo $row['Diagnosis']; ?></td>
                    <td>
                      <a href="getNewPatient.php?test=<?php echo $row['DoctorId']; ?>">  <a class="btn btn-danger" data-toggle="modal" data-target="#approvalModal" >Payment</a> </a>
                  ...
                  <div class="modal-content">
                    <div class="modal-header" >
                      <div class="panel panel-primary ">
                          <div class="panel-heading">
                            ...
                            <h4 class="modal-title">Payment Bill</h4>
                        </div>
                      </div>
                      <?php 
                          ...
                          <div class="modal-body">
                              <form method="post" action="dboperations.php" name="create">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="patientNo" id="name" placeholder="Patient Number" value="<?php echo $currentPatient ?>" required readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" rows="5" id="village" placeholder="Diagnosis" name="diagnosis" readonly=""> <?php echo $row['Diagnosis'] ?></textarea>
                                </div>
                                <?php
                                        }
                                      }
                                  ?>
                                <div class="form-group">
                                  <label for="bb">Lab Fee:</label>
                                  <input type="number" class="form-control" name="labfee" id="bb" placeholder="Lab fee:"  required>
                                </div>
                                <div class="form-group">
                                  <label for="tt">Consultation fee:</label>
                                  <input type="number" class="form-control" name="consultationfee" id="tt" placeholder="Consultation Fee"  required>
                                </div>
                                <div class="form-group">
                                  <label for="vv">Pharmacy fee:</label>
                                  <input type="number" class="form-control" name="pharmacyfee" id="vv" placeholder="Pharmacy fee:"  required>
                                </div>
                      </div>
                  </div>                    
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-primary pull-left" data-dismiss="modal">Close</button>
                       <button type="submit" name="billings" class="btn btn-primary">Save</button>
